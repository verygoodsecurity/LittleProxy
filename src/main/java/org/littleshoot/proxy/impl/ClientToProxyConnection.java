...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
    ...
    ClientToProxyConnection(
        ...
        processingEventLoopGroup =
            new GlobalStateWrapperEvenLoop(this.channel, new ProcessingEvenLoop(this.channel));
    ...
    private ConnectionState doReadHTTPInitial(HttpRequest httpRequest) {
        ...
        try {
            filterInstance = proxyServer.getFiltersSource().filterRequest(currentRequest, this.channel);
        } finally {
